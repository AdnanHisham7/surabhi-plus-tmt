...
const CompanyPage: React.FC = () => {
  ...
  const timeline = [
    { year: '1998', event: 'Company founded with a vision to revolutionize steel manufacturing' },
    { year: '2002', event: 'First TMT production line commissioned with capacity of 50,000 MT/year' },
    { year: '2008', event: 'ISO 9001:2008 certification achieved, expansion to 200,000 MT/year' },
    { year: '2015', event: 'Second manufacturing unit established, capacity increased to 350,000 MT/year' },
    { year: '2020', event: 'Advanced automation implemented, achieved 500,000 MT/year capacity' },
    { year: '2023', event: 'Sustainability initiatives launched, carbon footprint reduced by 30%' }
  ];
  ...
  const values = [
    {
      ...
      description: 'Unwavering commitment to delivering superior quality products that exceed industry standards.'
    },
    {
      icon: Users,
      title: 'Customer Focus',
      description: 'Building lasting relationships through exceptional service and innovative solutions.'
    },
    {
      icon: Globe,
    ...
    },
    {
      icon: Heart,
      title: 'Integrity',
      description: 'Conducting business with transparency, honesty, and ethical practices.'
    }
  ];
  ...
  const csrInitiatives = [
    {
      ...
      description: 'Scholarship programs and infrastructure development for rural schools',
      impact: '500+ students benefited'
    },
    {
      title: 'Healthcare Access',
      description: 'Mobile medical units and health camps in underserved communities',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-steel-50 to-white">
      {/* Hero Section */}
      <section className="relative py-20 bg-gradient-to-r from-steel-900 to-blue-900 text-white overflow-hidden">
        ...
        <div ref={heroRef} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center transition-all duration-1000 ${heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              ...
              <span className="block text-orange-400">Steel Excellence</span>
            </h1>
            <p className="text-xl md:text-2xl text-steel-200 max-w-3xl mx-auto leading-relaxed">
              For over 25 years, SurabhiPlusTMT has been at the forefront of steel innovation, 
              setting industry standards for quality, sustainability, and technological advancement.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={timelineRef} className={`text-center mb-16 transition-all duration-1000 ${timelineInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl text-steel-600 max-w-3xl mx-auto leading-relaxed">
              From humble beginnings to industry leadership - the milestones that shaped our legacy.
            </p>
          </div>
                ...
                >
                  <div className={`lg:w-1/2 ${index % 2 === 0 ? 'lg:pr-12 lg:text-right' : 'lg:pl-12 lg:order-2'}`}>
                    <Card className="relative">
                      ...
                      <p className="text-steel-700 leading-relaxed">{item.event}</p>
                    </Card>
                  </div>
                  ...
                  <div className={`lg:w-1/2 ${index % 2 === 0 ? 'lg:pl-12 lg:order-2' : 'lg:pr-12'}`}></div>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Company Values */}
      <section className="py-20 bg-gradient-to-r from-steel-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-steel-900 mb-4">{value.title}</h3>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={teamRef} className={`text-center mb-16 transition-all duration-1000 ${teamInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl md:text-5xl font-bold text-steel-900 mb-6">
              Leadership <span className="text-orange-500">Team</span>
            </h2>
            <p className="text-xl text-steel-600 max-w-3xl mx-auto leading-relaxed">
              Experienced leaders driving innovation and excellence in steel manufacturing.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {leadership.map((member, index) => (
              ...
              >
                ...
                />
                <h3 className="text-xl font-bold text-steel-900 mb-2">{member.name}</h3>
                <p className="text-orange-600 font-semibold mb-1">{member.position}</p>
                <p className="text-steel-500 text-sm mb-2">{member.department}</p>
                <div className="flex items-center justify-center space-x-1 mb-3">
                  <Award className="h-4 w-4 text-blue-500" />
                  <span className="text-blue-600 text-sm font-medium">{member.experience}</span>
                </div>
      ...
      {/* CSR Initiatives */}
      <section className="py-20 bg-gradient-to-r from-blue-900 to-steel-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Corporate Social <span className="text-orange-400">Responsibility</span>
            </h2>
